  ...
  return (
    <TableHead>
      <TableRow>
        ...
        {data.length === 0 ? <TableCell></TableCell> : data?.data[0]?.map((headCell, i) => (
          <TableCell
...
export default function EnhancedTable() {
  ...
  const productResults = useSelector(state => state.product.productList)
        ...
        <TableContainer>
          ...
          >
            ...
            <TableBody>
              ...
              {productResults?.data?.slice(1).map((row, index) => {
